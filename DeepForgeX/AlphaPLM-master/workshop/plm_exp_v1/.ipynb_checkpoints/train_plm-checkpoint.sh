para="-piece_num 4 -u_stdev 0.01 -u_alpha 0.1 -u_beta 1 -u_l1 1 -u_l2 100 -w_stdev 0.01 -w_alpha 0.1 -w_beta 1 -w_l1 1 -w_l2 100 -core 8"

model_out="./output/base"
train_dtm=$1
train_data="../../click/sample/sample_$1"
