...
from metaspore.algos.multi_domain import STARModel
...
class LtvModelTrainFlow(MsModelTrainFlow):
    def __init__(self, config_path):
        ...
        self.quantiles = None
        self.target_quantile = 0.7
        self.batch_days = 30 # 一次训练 N 天的数据
    ...
    def _preprocess_dataset(self, df):
        ...
        df = df.filter("business_type not in('alibaba') and revenue>0 and revenue<100")
