...
from metaspore.algos.multitask import MtlMMoEModel, MdlMMoEModel, MMoE, MtlSharedBottomModel
...
class MTLModelTrainFlow(MsModelTrainFlow):
    ...
    def _preprocess(self):
        ...
        MovasLogger.log(f'task_to_id_map = {self.task_to_id_map}, task_cnt = {task_cnt}')
