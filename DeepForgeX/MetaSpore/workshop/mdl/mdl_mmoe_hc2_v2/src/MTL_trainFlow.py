...
from metaspore.algos.multi_task import MtlMMoEModel, MdlMMoEModel, MMoE, MtlSharedBottomModel, SceneAwareMMoE, HoME, UncerWgtMMoE, MultiLayerPLEMD, PEPNet, PEPNet2
...
class MTLModelTrainFlow(MsModelTrainFlow):
    ...
    def _build_model_module(self):
        ...
        if configed_model == "mmoe_mtl": #最简单的 MMoE
