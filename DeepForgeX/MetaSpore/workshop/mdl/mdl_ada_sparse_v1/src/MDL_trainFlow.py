...
from metaspore.algos.multi_domain import HC2WideDeepModel, STARModel, StarGateModel, HC2STARModel, HC2MMoEModel, AdaSparseMDLModel
...
class MDLModelTrainFlow(MsModelTrainFlow):
    ...
    def _build_model_module(self):
        ...
        elif configed_model == "hc2":
            self.model_module = HC2WideDeepModel( #基于对比学习的 MDL
                num_domains=self.domains_cnt,
                ...
                net_dropout=self.net_dropout,
                embedding_dim=self.embedding_size,
                deep_hidden_units=self.dnn_hidden_units,
                ftrl_l1=self.ftrl_l1,
                ftrl_l2=self.ftrl_l2,
                ftrl_alpha=self.ftrl_alpha,
                ftrl_beta=self.ftrl_beta
