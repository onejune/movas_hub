...
# -*- coding: utf-8 -*-
"""
metaspore.utils.notifier - 飞书通知模块
...
class FeishuNotifier:
    ...
    使用方式:
        FeishuNotifier.send_text("消息内容")
        FeishuNotifier.send_dataframe_html(df, title="标题", subject="主题")
    """
    ...
    @staticmethod
    def send_evaluation_results_html(
        sorted_results: List, 
        test_date_str_formatted: str, 
        model_name: str
    ) -> Dict:
        """发送模型评估结果"""
