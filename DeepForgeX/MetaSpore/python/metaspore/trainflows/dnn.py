...
# -*- coding: utf-8 -*-
"""
metaspore/trainflows/dnn.py - DNN 模型训练流程

继承 BaseTrainFlow，只实现 _build_model_module (支持 15+ 模型类型)。
公共模块 (Spark管理/数据读取/训练/评估/主流程) 均在基类中。
"""
import os
import sys
import inspect
...
from metaspore.utils import MovasLogger


class DNNTrainFlow(BaseTrainFlow):
    """
    DNN 模型训练流程

    继承 BaseTrainFlow，实现 _build_model_module 支持以下模型:
...
if __name__ == "__main__":
    ...
    print(f'DNNTrainFlow: debug_args={args}')
