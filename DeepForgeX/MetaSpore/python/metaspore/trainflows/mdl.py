...
from metaspore.utils.metrics import compute_auc_and_pcoc_regression
...
from pyspark.sql import functions as F
from metaspore.trainflows.base import BaseTrainFlow
...
from metaspore.utils.logger import MovasLogger, how_much_time
...
class MDLModelTrainFlow(BaseTrainFlow):
    ...
    def _build_model_module(self):
        ...
        if configed_model == "star":
        ...
        elif configed_model == "star_dcn":
            self.model_module = StarCrossFusionModel(
                    num_domains = self.domains_cnt,
                    center_hidden_units = self.dnn_hidden_units,
                    domain_specific_hidden_units = self.domain_specific_hidden_units,
            ...
            self.model_module = DSWINModel(
                ...
                batch_norm=self.batch_norm,
                net_dropout=self.net_dropout,
                domain_branch_hidden_units=self.dnn_hidden_units,
                ftrl_l1=self.ftrl_l1,
                ftrl_l2=self.ftrl_l2,
                ftrl_alpha=self.ftrl_alpha,
                ftrl_beta=self.ftrl_beta
