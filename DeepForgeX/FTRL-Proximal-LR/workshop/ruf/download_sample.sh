...
while [ "$current_date" -le "$end_date" ]; do
    ...
    #ossutil cp -f oss://spark-ml-train-new/liufashuai/dsp/cps/union_purchase/union_sample_v2/sample_v2/$train_date/ ./temp/sample_$train_date --recursive
    ossutil cp -f oss://spark-ml-train-new/liufashuai/dsp/cps/union_purchase/ruf_sample_v1/sample_ruf_v1/$train_date/ ./temp/sample_$train_date --recursive
    ...
    shuf "./sample/sample_$train_date" -o "./sample/sample_$train_date"
    line_count=$(wc -l < ./sample/sample_$train_date)
    if [ "$line_count" -le 10000 ]; then
