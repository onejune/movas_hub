...
# 模型参数配置
declare -A params=(
    #["param1"]="-init_stdev 0.1 -w_l2 10.0 -w_l1 1.0 -v_l1 0 -w_alpha 0.05 -v_l2 5.0 -v_alpha 0.05 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 8,1,8"
    #["param2"]="-init_stdev 0.1 -w_l2 1.0 -w_l1 0.1 -v_l1 0 -w_alpha 0.1 -v_l2 5.0 -v_alpha 0.05 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 8,1,8"
    ...
    ["param5"]="-init_stdev 0.01 -w_l2 20.0 -w_l1 1 -v_l1 0.1 -w_alpha 0.1 -v_l2 5.0 -v_alpha 0.1 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8"
    ["param6"]="-init_stdev 0.01 -w_l2 5.0 -w_l1 5 -v_l1 0.1 -w_alpha 0.1 -v_l2 5.0 -v_alpha 0.01 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8"
    ["param7"]="-init_stdev 0.01 -w_l2 1.0 -w_l1 1 -v_l1 0.1 -w_alpha 0.1 -v_l2 1.0 -v_alpha 0.001 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8"
    ["param8"]="-init_stdev 0.01 -w_l2 0.1 -w_l1 1 -v_l1 0.1 -w_alpha 0.1 -v_l2 1.0 -v_alpha 0.05 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8"
    ["param9"]="-init_stdev 0.01 -w_l2 0.1 -w_l1 1 -v_l1 0.1 -w_alpha 0.1 -v_l2 0.1 -v_alpha 0.01 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8 -fvs 1"
    ["param10"]="-init_stdev 0.01 -w_l2 5.0 -w_l1 0.5 -v_l1 0.01 -w_alpha 0.1 -v_l2 5.0 -v_alpha 0.01 -w_beta 1.0 -v_beta 1.0 -core 8 -dim 1,1,8"
)
